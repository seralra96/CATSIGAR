    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<OnboarderPage> pages = Arrays.asList(
                ...
                new OnboarderPage.Builder()
                        ...
                        .description("Al abrir el módulo de Realidad Aumentada observarás que te dice 'escanea la construcción' " +
                                ...
                                " correspondiente a la placa domiciliaria del predio. Haz un paneo y aparecerá el modelo")
